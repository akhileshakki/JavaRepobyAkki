...
<body>
	...
	<p class="fl_left"><footer id="copyright" class="clear">
      
  </footer>
  				<div class="wrapper row4">Copyright &copy; 2018 - All Rights Reserved - <a href="index.html">Archy Akhilesh</a><p class="fl_right">Created by <a target="_blank" href="https://www.facebook.com/archyakhilesh/" title="Free Website Templates">Archy Akhilesh</a></p>
			</div>
		</div>
		<!-- content -->
	</div>
